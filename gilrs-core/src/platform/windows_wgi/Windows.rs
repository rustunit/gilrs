    ...
    pub mod Gaming {
        pub mod Input {
            ...
            impl Gamepad {
                ...
                pub fn Gamepads(
                ) -> windows_core::Result<super::super::Foundation::Collections::IVectorView<Gamepad>>
                {
                    Self::IGamepadStatics(|this| unsafe {
                        let mut result__ = core::mem::zeroed();
            ...
            pub struct IGameController_Vtbl {
                pub base__: windows_core::IInspectable_Vtbl,
                add_HeadsetConnected: usize,
                pub RemoveHeadsetConnected:
                    unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
                add_HeadsetDisconnected: usize,
                pub RemoveHeadsetDisconnected:
                    unsafe extern "system" fn(*mut core::ffi::c_void, i64) -> windows_core::HRESULT,
                add_UserChanged: usize,
            ...
            pub struct IRawGameController2_Vtbl {
                pub base__: windows_core::IInspectable_Vtbl,
                get_SimpleHapticsControllers: usize,
            ...
            impl RawGameController {
                ...
                pub fn RawGameControllers() -> windows_core::Result<
                    super::super::Foundation::Collections::IVectorView<RawGameController>,
                > {
                    Self::IRawGameControllerStatics(|this| unsafe {
                        let mut result__ = core::mem::zeroed();
